...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <style>
      @media print {
            /* Menyembunyikan elemen lain selain h3 dan tabel */
            body * {
                visibility: hidden;
            }
            ...
            /* Memastikan tombol cetak dan elemen lain tidak muncul saat mencetak */
            .no-print {
                display: none;
            }
            .no-print-column {
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <thead class="thead-dark">
                        <tr>
                                                ...
                                                <th>Nama</th>
                                                <th>Waktu</th>
                                                <th class="no-print-column">aksi</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="no-print-column"> <a href="absen/hapus_absen.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
