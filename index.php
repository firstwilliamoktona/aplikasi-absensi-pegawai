...
<head>
  ...
  <title>Absensi Pegawai PT Pelabuhan Mundam Sejahtera</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Absensi Pegawai PT Pelabuhan Mundam Sejahtera</h1>
              <p>Website ini berfungsi sebagai absensi pegawai PT Pelabuhan Mundam Sejahtera</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="section-margin">
      ...
      <div class="col-lg-12 danger text-center zero-panel">
        ...
        <ul class="list-inline" id="chart-skill">
          <li><a href="login.php"><button class="btn btn-warning" style="size: 50px;">Login Admin</button></a>
          </li><br>
          <li><a href="karyawan/login_karyawan.php"><button class="btn btn-primary" style="size: 50px;">Login Karyawan</button></a>
          </li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> CALVADEO APRINANDA PASKAH <i class="fa fa-heart" aria-hidden="true"></i></a>
</p>
